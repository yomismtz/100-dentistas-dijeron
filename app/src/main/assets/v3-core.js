...
const V3_CORE_VERSION='3.0.3-spoken-round-review';
...
function v3CoreMenu(){
  openModal('<h2>🧭 CENTRO DOCENTE Y ACADÉMICO</h2><div class="menuStack"><button id="v3AcademicMenu">🎓 HERRAMIENTAS ACADÉMICAS</button><button id="v3ShowMenuBtn">🎓 EXPERIENCIA Y AUDIO</button><button id="v3RecoverMenu">↻ RECUPERAR ÚLTIMA PARTIDA</button><button id="v3Rehearsal">🧪 MODO ENSAYO · 3 PREGUNTAS</button><button id="v3Latency">⚡ PRUEBA DE LATENCIA</button><button id="v3History">🗂 HISTORIAL / EXPORTAR</button><button id="v3Research">🔬 MODO INVESTIGACIÓN</button><button id="v3Packs">📦 PAQUETES DE CLASE</button><button id="v3Diff">🎚 DIFICULTAD POR RONDA</button><button id="v3Bracket">🏆 BRACKET DEL TORNEO</button><button id="v3Champ">🥇 GRAN CAMPEONATO</button></div>');
